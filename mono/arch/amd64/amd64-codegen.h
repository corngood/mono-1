...
#define amd64_can_call_code_size(inst,target,size) x86_can_call_code((inst),(target))
...
#define amd64_can_call_code(inst,target) amd64_can_call_code_size(inst,target,8)
